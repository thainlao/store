...
import img from '../assets/macbook1.png';

const Laptops = ({ onBuyClick }) => {
        ...
        <>
          ...
          >
            <div className="px-6 py-4">
              <div className="font-bold items-center flex justify-center text-xl mb-2">Macbook air M1</div>
              ...
              <div className={`flex items-center justify-center h-16 ${hoveredCard === 1 ? 'visible' : 'invisible'}`}>
                <button
                  ...
                  onClick={() => handleBuyClick(85000, 'Macbook air M2')}
                >
                  Купить
                </button>
              </div>
          ...
          >
            <div className="px-6 py-4">
              <div className="font-bold text-xl items-center flex justify-center mb-2">Macbook air M2</div>
              <div className="flex items-center justify-center">
              <img className="lg:w-32 py-2 w-32 h-32 lg:h-32" src={img} alt="Card image" />
            </div>
              ...
              <div className={`flex items-center justify-center h-16 ${hoveredCard === 2 ? 'visible' : 'invisible'}`}>
                <button
                  className="h-12 w-28 rounded-full shadow-md shadow-black text-white
                  transition ease-in-out delay-50 bg-[#5b566b] hover:bg-[#78718d]"
                  onClick={() => handleBuyClick(120000, 'Macbook air M1')}
                >
                  Купить
                </button>
              </div>
          ...
          >
            <div className="px-6 py-4">
              <div className="font-bold text-xl items-center flex justify-center mb-2">Macbook pro M1</div>
              <div className="flex items-center justify-center">
              <img className="lg:w-32 py-2 w-32 h-32 lg:h-32" src={img} alt="Card image" />
            </div>
              <p className="text-gray-700 items-center flex justify-center text-base">100 000 ₽</p>
              <div className={`flex items-center justify-center h-16 ${hoveredCard === 3 ? 'visible' : 'invisible'}`}>
                <button
                  className="h-12 w-28 rounded-full shadow-md shadow-black text-white
                  transition ease-in-out delay-50 bg-[#5b566b] hover:bg-[#78718d]"
                  onClick={() => handleBuyClick(100000, 'Macbook air M3')}
                >
                  Купить
                </button>
              </div>
